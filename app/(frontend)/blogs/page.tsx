                            ...
                            <div className="row">
                                <div className="col-md-8">
                                    <div className="sliderArea">
                                        ...
                                        >
                                            <SwiperSlide className="carouselItemWd">
                                                <img loading="lazy" src="/images/services/service1.webp" className="bSliderImg" />
                                            </SwiperSlide>
                                            <SwiperSlide className="carouselItemWd">
                                                <img loading="lazy" src="/images/services/service2.webp" className="bSliderImg" />
                                    ...
                                    <div>
                                        <a className="imgcardBox" href="#">
                                            <img loading="lazy" src="/images/services/service1.webp" className="bSliderImg" />
                                            <img loading="lazy" src="/images/logo_white.png" className="crdLogoImg" />
                                                ...
                                                <SwiperSlide className="multiCarouselItem">
                                                    <a href="#" className="blogCard">
                                                        <div className="bCardHead">
                                                            <img loading="lazy" src="/images/services/service1.webp" className="crlcardImg" />
                                ...
                                <div className="col-md-4">
                                    <div className="socialBox">
                                        ...
                                        <div className="socialFlexBar">
                                            ...
                                            <div className="socialIconsList">
                                                <a href="#">
                                                    <img loading="lazy" src="/images/icons/whatsapp-icon.png" className="socialIcon" />
                                                </a>
                                                <a href="#">
                                                    <img loading="lazy" src="/images/icons/whatsapp-icon.png" className="socialIcon" />
                                                </a>
                                    ...
                                    <div className="eventsCardArea">
                                        ...
                                        <a href="#" className="blogCard">
                                            <div className="bCardHead">
                                                <img loading="lazy" src="/images/services/service1.webp" className="eventCardImg" />
                                                <span className="cdTagBtn"> News</span>
                                                <div className="overlay">
                                                    <p className="crdText">
                                                        Emaar Beachfront, established in early 2018 within Dubai Harbour,
