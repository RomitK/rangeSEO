              ...
              <div className="row">
                <div className="col-12 col-lg-8 col-md-8">
                      ...
                      {propertyData?.gallery?.map((image, index) => {
                        return (
                          <SwiperSlide key={image.id + index + 'gallery2'}>
                            <img src={image.path} alt="range" className="img-fluid" />
                          </SwiperSlide>
                        );
                      })}
                    </Swiper>
                  ...
                  <div className="mb-3">
                        ...
                        <div className="col-12 col-lg-6 my-auto">
                          <a href="#" className="text-decoration-none">
                            <div className="mainHead text-primary">
                              <h4 className="mb-0">{propertyData && propertyData.name}</h4>
                            </div>
                          </a>
                        </div>
                        <div className="col-12 col-lg-6 my-auto">
                          <div className="videoPlaywrapper cursor-pointer" data-bs-toggle="modal"
                    ...
                    <div className="py-2">
                      <div>
                        <div className="fs-14">
                          {propertyData && parse(propertyData?.description ?? "")}
                        </div>
                      </div>
                    </div>
                  </div>
                      ...
                      <div className="">
                        <div className="row">
                          {propertyData?.amenities?.map((amenity, index) => {
                            return (<div className="col-6 col-lg-3 col-md-4 my-auto" key={amenity.id + index + 'amenities'}>
                              <div className="pb-3">
                                <div className="mb-2">
                                  <div className="amenityImg mx-auto">
                                    <img src={amenity.image} alt={amenity.name} className="img-fluid" width="40px" />
                                  </div>
                                </div>
                  ...
                  <div className="mb-3">
                      ...
                      <div className="row">
                        <div className="col-12 col-lg-12 my-auto">
                          <div className="aboutProImg">
                            <img src={propertyData?.mainImage} alt="kkk" className="img-fluid" />
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="py-2">
                      <div>
                        <div className="fs-14">
                          {propertyData && parse(propertyData?.longDescription ?? "")}
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="col-12 col-lg-4 col-md-4">
                  <div className="bg-light px-3 py-2 mb-5">
                    <div className="border-bottom border-2 py-3">
                      <p className="text-primary fw-500 mb-1 fs-20">PROPERTY STATUS</p>
                      <p className="fw-500 mb-0">For Sale</p>
                    </div>
                    <div className="border-bottom border-2 py-3">
                      <p className="text-primary fw-500 mb-1 fs-20">PROPERTY TYPE</p>
                      <p className="fw-500 mb-0">{propertyData && propertyData.accommodation}</p>
                    </div>
                    <div className="border-bottom border-2 py-3">
                      <ul className="list-unstyled">
                        <li className="mb-2">
                          <small><img src="/images/icons/bed-blue.png" alt="Range" className="img-fluid" width="30px" />
                            <span className="align-text-top ms-2 fs-16 fw-500">{propertyData && propertyData.bedrooms}</span>
                          </small>
                        </li>
                        <li className="mb-2">
                          <small><img src="/images/icons/bath-blue.png"
                            alt="Range" className="img-fluid" width="30px" />
                            <span className="align-text-top ms-2 fs-16 fw-500">{propertyData && propertyData.bathrooms}</span></small>
                        </li>
                        <li className="mb-2">
                          <small><img src="/images/icons/balcony.png"
                            alt="Range" className="img-fluid" width="30px" />
                            <span className="align-text-top ms-2 fs-16 fw-500">1 balcony</span></small>
                        </li>
                        <li className="mb-2">
                          <small><img src="/images/icons/area-blue.png"
                            alt="Range" className="img-fluid" width="30px" />
                            <span className="align-text-top ms-2 fs-16 fw-500">{propertyData && propertyData.area} Sq.Ft</span></small>
                        </li>
                        <li className="mb-2">
                          <small><img src="/images/icons/building.png"
                            alt="Range" className="img-fluid" width="30px" />
                            <span className="align-text-top ms-2 fs-16 fw-500">Emaar</span></small>
                        </li>
                        <li className="">
                          <small><img src="/images/icons/hand-over.png"
                            alt="Range" className="img-fluid" width="30px" />
                            <span className="align-text-top ms-2 fs-16 fw-500">Q4 2027
                              handover</span></small>
                        </li>
                      </ul>
                    </div>
                    <div className="py-3">
                      <div className="d-flex justify-content-start py-3">
                        <div className="my-auto projctSpecIMg me-3">
                          <center><img src="/images/icons/hand-over.png"
                            className="img-fluid" alt="range" width="60" /></center>
                        </div>
                        <div className="my-auto">
                          <div className="projectSpec  text-uppercase">
                            <p className="mb-0">AED {propertyData && propertyData.price}</p>
                    ...
                    <div className="py-3">
                      <div className="text-center mb-3">
                        <a
                          className="btn text-decoration-none bg-primary text-white  fs-18 fw-500 text-uppercase w-100 btn-lg" data-bs-toggle="modal"
                          data-bs-target="#bookAmeeting">SCHEDULE
                          VIEWING</a>
                      </div>
                      <div className="text-center">
                        <a
                          className="btn   text-decoration-none btn-success text-uppercase fs-18 fw-500 w-100 btn-lg"><i
                            className="fa fa-whatsapp"></i> &nbsp;CALL WHATSAPP</a>
                      </div>
                    </div>
                    <div className="py-3">
                      <div>
                        Share on:&nbsp;
                        <a href="" className="text-decoration-none  text-black"><small><img
                          src="/images/icons/whatsapp.png"
                          alt="Range" className="img-fluid" width="25px" /></small></a>
                        <a href="" className="text-decoration-none  text-black"><small><img
                  ...
                  <div className="bg-light px-3 py-2 mb-5">
                      ...
                      <form>
                        <div className="mb-3">
                          ...
                          <div className="input-group mb-3">
                            <span
                              className="input-group-text  rounded-0 border-end p-2 bg-white">AED</span>
                            <input type="text" className="form-control border-start-0  rounded-0"
                        ...
                        <div className="mb-3">
                          ...
                          <input type="range" className="form-range mb-3" id="customRange1"
                            min="20" max="80" value="20" />
                          <input type="text" className="form-control rounded-0 mb-2" placeholder="0" />
                        ...
                        <div className="mb-3">
                          <label className="form-label fw-500">RATE <small>(choose from the current best
                            options)</small></label>
                          <div className="input-group bg-white border">
                            <input type="text" className="form-control border-0" placeholder="4.24" />
                            <button
                              className="btn border border-primary text-primary px-2 py-1 rounded-circle m-1 "
                              type="button"><i className="bi bi-dash-lg"></i></button>
                            <button
                              className="btn border border-primary text-primary px-2 py-1 rounded-circle m-1 "
                    ...
                    <div className="p-4 my-2 bg-primary text-white text-center">
                      ...
                      <div className="mb-2"><a href="" className="text-white fs-16">VIEW CLOSING COSTS</a>
                      </div>
                      <p className="fs-14  mb-2">Estimated monthly payment based on
                        800,000 AED finance amount with a 6.35%
                        variable finance rate.</p>
                      <p className="fs-14  mb-0">Disclaimer Rates may vary based on bank
                  ...
                  <div className="bg-light px-3 py-2 mb-5">
                    <div className="py-3">
                      <p className="text-primary fw-500 mb-0 fs-20">{propertyData && propertyData.community && propertyData.community['name']}</p>
                    </div>
                    <div>
                      <div className="swiper pb-5 communityProjectSwiper">
                        <div className="swiper-wrapper">

                          <div className="swiper-slide">
                            <div className="communityImgCont">
                              <img src=""
                                alt="community1" className="img-fluid" />
                  ...
                  <div>
                    ...
                    <div className="row g-1">
                      <div className="col-6 col-lg-3 col-md-3">
                        <button className="btn btnNearby w-100 h-100" icon="graduation-cap"
                          btnNearbyKey="School">School</button>
                      </div>
                      <div className="col-6 col-lg-3 col-md-3">
                        <button className="btn btnNearby w-100 h-100" icon="building"
                          btnNearbyKey="Gym">Gym</button>
                      </div>
                      <div className="col-6 col-lg-3 col-md-3">
                        <button className="btn btnNearby w-100 h-100" icon="shopping-cart"
                          btnNearbyKey="Super market">Super
                          market</button>
                      </div>
                      <div className="col-6 col-lg-3 col-md-3">
                        <button className="btn btnNearby w-100 h-100" icon="h-square"
                          btnNearbyKey="Hospital">Hospital</button>
                      </div>
                      <div className="col-6 col-lg-3 col-md-3">
                        <button className="btn btnNearby w-100 h-100" icon="paw"
                          btnNearbyKey="pet shop">PET
                          SHOP</button>
                      </div>
                      <div className="col-6 col-lg-3 col-md-3">
                        <button className="btn btnNearby w-100 h-100" icon="shopping-bag"
                          btnNearbyKey="mall">MALL</button>
                      </div>
                      <div className="col-6 col-lg-3 col-md-3">
                        <button className="btn btnNearby w-100 h-100" icon="building-o"
                          btnNearbyKey="Gas Station">GAS
                          STATION</button>
                      </div>
                      <div className="col-6 col-lg-3 col-md-3">
                        <button className="btn btnNearby w-100 h-100" icon="cutlery"
                ...
                <div className="col-12 col-lg-4 col-md-4">
                  <div className="bg-light px-3 py-2 h-100">
                    <div className="py-3">
                      <p className="text-primary fw-500 mb-1 fs-20">NEARBY LOCATION</p>
                    </div>
                    <div className="border-bottom border-2 py-3">
