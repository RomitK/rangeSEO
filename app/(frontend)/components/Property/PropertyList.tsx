...
import { GoogleMap, InfoWindow, MarkerF, useLoadScript, OverlayView, DrawingManagerF } from "@react-google-maps/api";
...
const PropertyList = ({ params }) => {
  ...
  const handleMarkerClick = (slug, id, lat, lng, address, name, area, bedrooms, bathrooms, price, property_banner) => {
      setInfoWindowData({
          slug,
          id,
          address,
  ...
  return (
      <div className="container-fluid px-0">
          <div className="row g-0">
                              ...
                              >
                                  ...
                                  <DrawingManagerF
                                      onPolygonComplete={(polygon) => {
                                          ...
                                          const markersInsidePolygon = originalMarkers.filter((marker) =>
              ...
              <div className={`col-12 col-sm-12 ${showMap ? "col-md-6" : "col-md-12"}`}>
                  <div id="dataTable">
                      <div>
                          ...
                          <div>
                              <div className="col-12 col-lg-12 col-md-12">
                                  <div className="row g-3">
                                      <div className="col-12 col-lg-12 col-md-12">
                                          <p className="text-primary mb-0">{properties.length} results found</p>
                                      </div>
                                      {properties.map((property, index) => (
                                          <div
                                              key={index}
                                              className={`col-12 ${showMap ? "col-lg-6" : "col-lg-3"} col-md-6`}
                                          >
                                              <Property
                                                  slug={property.slug}
                                                  area={property.area}
