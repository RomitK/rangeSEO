                                    ...
                                    <div className="col-12 col-lg-12 col-md-12">
                                        <div>
                                            <div className="mainHead mb-3 text-center">
                                                ...
                                                {developerData && developerData.longDescription && parse(developerData.longDescription)}
                                            </div>
                                        </div>
                                    </div>
                                                        ...
                                                        <SwiperSlide key={img.id + index + 'gallery'}>
                                                            <div className="swiper-slide">
                                                                <div className="communityImgCont">
                                                                    <img src={img.path} alt="community1" className="img-fluid communityGalleryImage" />
                                                                </div>
                                                            </div>
                                                        </SwiperSlide>
                                                    );
                        ...
                        <div className="col-12 col-lg-12 col-md-12">
                            <div className="row g-0">
                                    ...
                                    <div className="row g-0 justify-content-center mb-4">
                                        <div className="col-10 col-lg-2 col-md-3  mx-3 my-auto">
                                            <div className="bg-white shadow px-3 py-2">
                                                <p className="text-primary mb-1 fw-semibold">NEW PROJECTS</p>
                                                <div>
                                                    <select name="" id=""
                                        ...
                                        <div className="col-10 col-lg-2 col-md-3 mx-3 my-auto">
                                            <div className="bg-white shadow  px-3 py-2">
                                                <p className="text-primary mb-1 fw-semibold">PRICE RANGE</p>
                                                <div>
                                                    <select name="" id=""
                                                        className="form-select form-select-sm border-0">
                                                        <option value="">All</option>
                                ...
                                {developerData?.projects?.map((project, index) => {
                                    return (
                                        <div className="col-12 col-lg-3 col-md-3" key={project.id + index}>
                                            <div className="projectImgCont">
                                                <img src={project.mainImage} alt={project.title} className="img-fluid" />
                                                <div className="projectImgOverlay">
                                                    <div><span className="badge projectType">{project.accommodation}</span></div>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-12 col-lg-12 col-md-12">
                                        ...
                                        >
                                                                    ...
                                                                    <div>
                                                                        <div className="">
                                                                            <a href="" className="text-decoration-none">
                                                                                <div className="projectImgCont">
                                                                                    <img src={community.mainImage} alt={community.name} className="img-fluid propImg" />
                                                                                </div>
                                                                            </a>
                                                                        </div>
                                                                        <div className="card-body rounded-3 rounded-top-0">
                                                                            <a href="#" className="text-decoration-none">
                                                                                <div className="mb-1 text-center">
                                                                                    <h5 className="text-black">{community.name}</h5>
                                                                                </div>
                                                                            </a>
                                                                        </div>
                                                                    </div>
                                            ...
                                            <div className="" onClick={() => swiperRef.current?.slideNext()} onClick={() => swiperRef.current?.slideNext()}>
                                                <span className='swiper-button-prev swiperUniquePrev text-primary'>
                                                    <i className='bi bi-chevron-left fs-1'></i>
                                                </span>
                                            </div>
                                            <div className="swiper-button-next swiperUniqueNext text-primary " onClick={() => swiperRef.current?.slidePrev()}>
                                                <span className=''>
                                                    <i className='bi bi-chevron-right fs-1'></i>
                                                </span>
                                            </div>
