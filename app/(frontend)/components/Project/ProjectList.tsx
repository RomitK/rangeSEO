...
function ProjectList(){
    ...
    useEffect(() => {
        fetch('https://rangenew.websitedemo.world/api/getHomeProjects', {
            method: 'GET',
            mode: 'cors',
            headers: {
                    ...
                    <div className="row g-0">
                        ...
                        </div>
                        {
                            projects.map((project)=>{
                                return <div className="col-12 col-lg-3 col-md-3" key={project['id']}>
                                    <div className="projectImgCont">
                                        <img src={project['mainImage']} alt={project['title']} className="img-fluid" />
                                        <div className="projectImgOverlay">
                                            <div><span className="badge projectType">
                                                {project['accommodations'] && project['accommodations'][0]['name']}
