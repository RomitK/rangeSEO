                ...
                <div className="col-12 col-lg-8 col-md-8">
                  ...
                  <div className="mb-3">
                        ...
                        <div className="col-12 col-lg-6 my-auto">
                          <a href="#" className="text-decoration-none">
                            <div className="mainHead text-primary">
                              <h4 className="mb-0">{projectData && projectData.name}</h4>
                            </div>
                          </a>
                        </div>
                        <div className="col-12 col-lg-6 my-auto">
                    ...
                    <div className="py-2">
                      <div>
                        <div className="fs-14">
                          {projectData && parse(projectData?.shortDescription ?? "")}
                        </div>
                      </div>
                    </div>
                  </div>
                  {projectData && projectData.amenities && (
                    <div className="mb-3">
                      <div className="py-3">
                        <div className="mainHead text-primary">
                  ...
                  <div className="mb-3">
                      ...
                      <div className="row">
                        <div className="col-12 col-lg-12 my-auto">
                          <div className="aboutProImg">
                            <img src={projectData?.mainImage} alt="kkk" className="img-fluid" />
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="py-2">
                      <div>
                        <div className="fs-14">
                          {projectData && parse(projectData?.longDescription ?? "")}
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="col-12 col-lg-4 col-md-4">
                  <div className="bg-light px-3 py-2 mb-5">
                    ...
                    <div className="border-bottom border-2 py-3">
                      ...
                      <p className="fw-500 mb-0">Villas</p>
                    </div>
                    <div className="border-bottom border-2 py-3">
                      <ul className="list-unstyled">
                        <li className="mb-2">
                          <small><img src="/images/icons/bed-blue.png" alt="Range" className="img-fluid" width="30px" />
                            <span className="align-text-top ms-2 fs-16 fw-500">4 & 5 bedrooms</span>
                          </small>
                        </li>
                        <li className="mb-2">
                          <small><img src="/images/icons/bath-blue.png"
                            alt="Range" className="img-fluid" width="30px" />
                            <span className="align-text-top ms-2 fs-16 fw-500">2 bathrooms</span></small>
                        </li>
                        <li className="mb-2">
                        ...
                        <li className="mb-2">
                          <small><img src="/images/icons/area-blue.png"
                            alt="Range" className="img-fluid" width="30px" />
                            <span className="align-text-top ms-2 fs-16 fw-500">BUA 200400
                              sq.ft.</span></small>
                        </li>
                        <li className="mb-2">
                      ...
                      <div className="d-flex justify-content-start py-3">
                        ...
                        <div className="my-auto">
                          <div className="projectSpec  text-uppercase">
                            <p className="mb-0">AED 89,000</p>
                            <p className="text-primary mb-0 fs-20">Starting Price</p>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="bg-light px-3 py-2 mb-5">
                    <div className="py-3">
                      <p className="text-primary fw-500 mb-0 fs-20">JVR COMMUNITY</p>
                    </div>
                    <div>
                            ...
                            <div className="communityImgCont">
                              ...
                              <div className="communityImgOverlay">
                                <div className="text-white">
                                  <p className="fw-bold mb-1">Palmiera - The Oasis</p>
                                </div>
                              </div>
                            </div>
                          </div>
