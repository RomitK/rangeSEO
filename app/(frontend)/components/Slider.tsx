            ...
            >
                <SwiperSlide>
                    <div className="lifestyleBox" >
                        <img loading="lazy" src="images/community/community1.png" className="img-fluid lifeStyleIMg" alt="Golf Estate" />
                        <div className="card-body py-2">
                            ...
                            <a href="#" className="card-link"><span className='align-middle'>READ MORE</span> &nbsp; <img loading="lazy" src="/assets/frontend/images/icons/arrow-right.webp" className="img-fluid align-middle" width={8} alt="Golf Estate" /></a>
                        </div>
                    </div>
                </SwiperSlide>
                <SwiperSlide>
                ...
                <div className="row pt-5">
                    <div className="col-12 col-lg-6 col-md-6 my-auto">
                        <div className="d-flex">
                            <div className='swiperPrev me-3' onClick={() => swiperRef.current?.slidePrev()}>
                                <img loading="lazy" src="/assets/frontend/images/icons/prev.webp" alt="Elite Properties" className="img-fluid" width={45} />
                            </div>
                            <div className='swiperNext me-5' onClick={() => swiperRef.current?.slideNext()} >
                                <img loading="lazy" src="/assets/frontend/images/icons/next.webp" alt="Elite Properties" className="img-fluid" width={45} />
                            </div>
                    ...
                    <div className="col-12 col-lg-6 col-md-6 my-auto">
                        <div className="lifestyleBox py-2 float-end">
                            <a href="#" className="card-link"><span className='align-middle'>DISCOVER MORE</span> &nbsp; <img loading="lazy" src="/assets/frontend/images/icons/arrow-right.webp" className="img-fluid align-middle" width={8} alt="Golf Estate" /></a>
                        </div>
                    </div>
                </div>
            </Swiper>
