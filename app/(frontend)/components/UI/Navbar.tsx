...
function Navbar() {
    ...
    const expandPropertyDropdown = ['/properties', '/ready', '/rent', '/off-plan', '/luxury-properties'].includes(usePathname());
    return (
        <>
            {homePage &&
                            ...
                            <div className="d-flex navMobRev">
                                <ul className="navMainPc d-none d-lg-flex d-md-flex navMenu my-auto me-3">
                                    <li className="dropdown navDropMain nav-item">
                                        <a href="/properties" className="dropdown-toggle nav-link " data-toggle="dropdown">Properties <b
                                            className="caret"></b></a>
                                        <ul className="dropdown-menu">
                                            <li className="dropdown navDropSub dropdown-submenu"><a className="dropdown-toggle mainLink"
                                                data-toggle="dropdown">Buy</a>
                                                <ul className="dropdown-menu">
                                                    <li className="">
                                                        <a className="" href="/ready">Ready</a>
                                                    </li>
                                                    <li className="">
                                                        <a className="" href="off-plan'">Off-plan</a>
                                                    </li>
                                            ...
                                            <Link className="mainLink" href="/rent">Rent</Link>
                                    ...
                                    <li className="dropdown navDropMain nav-item">
                                        <a className="dropdown-toggle nav-link " data-toggle="dropdown">Insights<b
                                            className="caret"></b></a>
                                        <ul className="dropdown-menu">
                                            <li className=""><a href="" className="mainLink">Dubai Trends</a></li>
                                            <li className="">
                                    ...
                                    <li className="dropdown navDropMain nav-item">
                                        <a className="dropdown-toggle nav-link " data-toggle="dropdown">About<b
                                            className="caret"></b></a>
                                        <ul className="dropdown-menu">
                                            <li className=""><a href="" className="mainLink">Range</a></li>
                                            <li className=""><a href="" className="mainLink">Management</a></li>
                                            <li className=""><a href="" className="mainLink">Agents</a></li>
                                            <li className=""><a href="" className="mainLink">Achievements</a></li>
                                        </ul>
                                    </li>

                                    <li className="dropdown navDropMain nav-item">
                                        <a className="dropdown-toggle nav-link " data-toggle="dropdown">Contact<b
                                            className="caret"></b></a>
                                        <ul className="dropdown-menu">
                                            <li className=""><a href="" className="mainLink">Contact Us</a></li>
                                            <li className=""><a href="" className="mainLink">Career</a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <div className="offcanvas offcanvas-end" tabIndex="-1" id="offcanvasRight"
                                        ...
                                        <div className="offcanvas-body">
                                            <ul className="list-unstyled dropList">
                                                ...
                                                <li className="nav-item py-3 border-bottom">
                                                    <a className="nav-link" href="">Blogs and News</a>
                                                </li>
                                                <li className="nav-item py-3 border-bottom">
                                                    <a className="nav-link" href="">Dubai Guide</a>
                                                </li>
                                                <li className="nav-item py-3 border-bottom">
                                                    <a className="nav-link" href="">Investment Guide</a>
                                                </li>
                                                <li className="nav-item py-3 border-bottom">
                                ...
                                <div className="my-auto">
                                    <div className="d-flex justify-content-end">
                                        ...
                                        <div className="my-auto text-uppercase text-end fs-14 navMob14 text-primary">
                                            <div><span className="fw-bold">Toll free</span> 800 72 888</div>
                                        </div>
                                    </div>
                                </div>
            ...
            {!homePage && <nav className="navbar bg-blue ">
                <div className="container py-3">
                    <div className="my-auto">
                        <Link href={{ pathname: '/' }} className="navbar-brand">
                    ...
                    <div className="my-auto">
                        ...
                        <div className="d-flex navMobRev">
                            <ul className="navMainPc navBlue navMenu d-none d-lg-flex d-md-flex my-auto me-3">
                                {expandPropertyDropdown &&
                                    <li className="nav-item">
                                        <a className="nav-link" href="ready">Ready</a>
                                    </li>
                                }
                                {expandPropertyDropdown &&
                                    <li className="nav-item">
                                ...
                                {expandPropertyDropdown &&
                                    <li className="nav-item">
                                        <a className="nav-link" href="off-plan">OFF-PLAN</a>
                                    </li>
                                }
                                {expandPropertyDropdown &&
                                    <li className="nav-item">
                                        <a className="nav-link" href="luxury-properties">LUXURY PROPERTIES</a>
                                    </li>
                                }
                                ...
                                {!expandPropertyDropdown &&
                                    <li className="dropdown navDropMain nav-item">
                                        ...
                                        <ul className="dropdown-menu">
                                            ...
                                            <li className=""><a href="rent" className="mainLink">Sell</a></li>
                            ...
                            <div className="my-auto">
                                ...
                                <div>
                                    <button type="button" className="btn btn-primary rounded-0 fs-12 btn-sm w-100">SELL WITH US</button>
                                </div>
                            </div>
