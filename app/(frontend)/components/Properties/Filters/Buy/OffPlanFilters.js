...
function OffPlanFilters({
  ...
  useEffect(() => {
    let getPropertiesAreaURL = process.env.API_HOST + "properties/offplan/areaList";
    let getPropertiesPriceURL =
      process.env.API_HOST + "properties/offplan/priceList";
