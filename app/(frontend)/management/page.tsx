        ...
        <>
          <div className="container">
                ...
                <section  className="section carouselSection">
                     <video className="sectionImgVideo" autoPlay loop muted preload="metadata" poster="/images/services/service-header.webp">
                ...
                <section className='section'>
                <h4 className="sctionMdTitle text-primary mb-5">AWARD WINNING TEAM</h4>
                        ...
                        slidesPerView={3}  navigation={true}  className="mySwiper multiItemsSlider">
                                        <SwiperSlide>
